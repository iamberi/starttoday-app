...
export class AuthService {
  ...
  userData: any; // speichert logged nutzer daten

  constructor(
    public afs: AngularFirestore,   // Firestore service
    public afAuth: AngularFireAuth, // Firebase auth service
    public router: Router,
    public ngZone: NgZone // NgZone service um outside scope warning zu entfernen
  ){
  ...
  //Validierung, wenn Nutz eingelogged ist und E-Mail verifiziert ist
